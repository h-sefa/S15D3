...
public class WordCounter {
    ...
    public static Map<String,Integer> calculatedWord() {
        ...
        Map<String, Integer> mappedSentence = new HashMap<>();
       String[] arrOfSentence = sentence.split("\\s+");
       for(String str :arrOfSentence){
           String editedStr= str.toLowerCase().replaceAll("[,.?!\\\\]+","");
           mappedSentence.put(editedStr, mappedSentence.getOrDefault(editedStr, 0)+1);
       }
